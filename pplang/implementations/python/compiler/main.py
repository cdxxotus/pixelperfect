...
print(f"Compilation time for data: {compile_time*1000:.1f}ms")
print(f"Uncompilation time for data: {uncompile_time*1000:.1f}ms")
print(f"Compilation time for string: {compile_string_time*1000:.1f}ms")
print(f"Uncompilation time for string: {uncompile_string_time*1000:.1f}ms")
